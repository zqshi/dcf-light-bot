(function () {
  ...
  const PAGE_PERMISSION_COMPAT = {
    'admin.runtime.read': [
      ...
      'admin.runtime.page.openclaw-config.read'
    ],
    ...
    'admin.ai-gateway.read': ['admin.ai-gateway.page.read'],
    'admin.auth.read': [
    ...
    'admin.runtime.page.openclaw-config.read': ['admin.runtime.read'],
    ...
    'admin.ai-gateway.page.audit.read': ['admin.ai-gateway.read', 'admin.runtime.read'],
    'admin.ai-gateway.page.risk-rules.read': ['admin.ai-gateway.read', 'admin.runtime.read'],
    'admin.ai-gateway.read': ['admin.ai-gateway.page.audit.read', 'admin.ai-gateway.page.risk-rules.read']
  };
  ...
  function applyNavAcl(session, acl) {
    ...
    const sectionPathMap = new Map([
      ['/admin/logs-service.html', '/admin/logs-service.html'],
      ['/admin/logs-agent.html', '/admin/logs-service.html'],
      ['/admin/logs-admin.html', '/admin/logs-service.html'],
    ...
    for (const item of primaryItems) {
      ...
      if (item.path === '/admin/logs-service.html' && logsGroupChildren.length > 0) {
        const group = document.createElement('div');
        group.className = 'sidebar-group';
        group.innerHTML = `
          <button
